  ...
  useEffect(() => {
    async function init() {
      try {
        ...
        const savedChatConfig = await loadChatLlmConfig()
        useWikiStore.getState().setChatLlmConfig(savedChatConfig)
